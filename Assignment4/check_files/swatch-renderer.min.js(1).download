...
if(this.options.jsonConfig!==''&&this.options.jsonSwatchConfig!==''){this.options.jsonConfig.mappedAttributes=_.clone(this.options.jsonConfig.attributes);this._sortAttributes();this._RenderControls();$(this.element).trigger('swatch.initialized');if(this.options.jsonConfig.attributes.length>1){$(this.options.jsonConfig.attributes).each(function(){var _options=[];$(this.options).each(function(key,value){if(value.products.length>0){_options.push(key);}});if(_options.length==1){var variantCode=$(this)[0].code;var _swatch_option=$('.swatch-opt .'+variantCode+' .swatch-attribute-options div.swatch-option:not(.selected)').first();if(!_swatch_option.hasClass('selected')){_swatch_option.click();}}});}}else{console.log('SwatchRenderer: No input data received');}
...
html=html+'<div class="product item-image imgzoom" data-zoom="'+imagesToUpdate[index].img+'"><a href="'+href+'" class="'+cla+'"><img class="img-responsive" src="'+imagesToUpdate[index].full+'" alt=""/></a></div>';}else{html=html+'<div class="product item-image imgzoom" data-zoom="'+imagesToUpdate[index].img+'"><img class="img-responsive" src="'+imagesToUpdate[index].full+'" alt=""/>';if(imagesToUpdate[index].type=='video'&&imagesToUpdate[index].videoUrl!=""){html=html+'<a target="_blank" class="popup-youtube btn btn-primary" href="'+imagesToUpdate[index].videoUrl+'">'+$.mage.__('Watch Video')+'</a>';}
